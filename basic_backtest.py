...
def calc_trade_profit(data, price_df, returns_df, capital_available_start, current_date,\
                      allocation_fraction, alpha_required, max_loss_probability, spread_length, slippage_abs,\
                         slippage_per, t_df, VIX_prev):
...
## Loop function
def backtest_func(df, price_df, returns_df, start_date, alpha_required,\
                  delta_long, allocation_fraction,\
    ...
    while(1):
        ...
        df, price_df, returns_df, capital_available, current_date, allocation_fraction,\
                        alpha_required, delta_long, spread_length, slippage_abs,\
                            slippage_per, t_df, VIX_prev)
